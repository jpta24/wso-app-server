              ...
              <div>
                  <div style='padding:10px'>
                      <a href='https://wso-security.com/en/' style='display:flex; text-decoration: none; background-color: #000000'>
                          <img src='https://res.cloudinary.com/dwtnqtdcs/image/upload/v1674569884/secuApp-gallery/wso-logo_umapwp.png' width="60px" height="60px"/>
                          <h1 style='margin-left:15px; color:#ffffff'>WSO Worldwide Security Options</h1>
                      </a>
                  </div>
                  <div style='padding:10px'>
                      ...
                      <div>
                          <div>
                              <div>
                                  <hr/>
                                  <h3>Thanks for signing up.  You can now create a Business or you can start add yourself to the Business you work for. </h3>
